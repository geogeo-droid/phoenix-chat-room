defmodule TomboChatWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule TomboChat.MyChannel do
  ...
  def fetch(_topic, entries) do
    ...
    # "1" is user_id. see Presence.track's key argument
    users =
      entries
      |> Map.keys()
      |> TomboChat.Accounts.list_users_with_ids()
      |> Enum.into(%{}, fn user ->
